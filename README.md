This work was done for my Bachelor thesis "Staggered Quantum Walk on Weighted Graphs". The goal was to: 

1) Analyse and benchmark of the Staggered Quantum Walk framework applied to a variety of problems
2) Extension of the Staggered Quantum Walk to Weighted Graphs and proposal of a Pathfinding algorithm for a specific eletrical network problem
